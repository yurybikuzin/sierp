...
(function ($) {
    ...
    (function ($$) {
        ...
        const $sierp_control_app_dot = {
            type: '$sierp_control_app_dot',
            prop: {
                '#isHover': $$.$me_atom2.fn_compute_false,
                'cursor': $$.$me_atom2_prop(['.#isHover'], fn_compute_cursor, fn_apply_cursor),
            },
            render: p => {
                $$.$me_atom2_ctx_circle(Object.assign({}, p, $$.$me_atom2_ctxCenterOf(p), { ctxRadius: $$.$me_atom2_ctxWidthOf(p) / 2, fillStyle: $$.a('.backgroundColor') }));
            }
        };
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
